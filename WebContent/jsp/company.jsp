...
<body>
	<form id="J_Form" class="form-horizontal span24" name="form"
		method="post" action="bizlist_add" namespace="/">
		<div class="container">
			<div class="row">
					...
					<div class="control-group span8">
						...
						<div class="controls">
							<select data-rules="{required:true}" 
								class="input-normal" id="companyname" name="companyname">
				...
				<div class="row">
					...
					<div class="control-group span8">
						...
						<div id="range" class="controls bui-form-group"
							...
							<input id="startdate" name="startdate" class="calendar" data-rules="{date:true}"
