...
<c:if test="${!empty transport}"  >
	<form id="J_Form" class="form-horizontal span24" name="form"
		method="post" action="transport_update?tid=${transport.tid}" namespace="/">
				...
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							...
							class="input-normal control-text" value="${transport.tno}"/>
						</div>
					</div>
					<!--companyname-->
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tname" name="tname" type="text" 
								class="input-normal control-text" value="${transport.tname}"/>
						</div>
					</div>					
					...
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="taddr" name="taddr" type="text"
								class="input-normal control-text" value="${transport.taddr}"/>
						</div>
					</div>
					<div class="control-group span8">
						<label class="control-label">联系人:</label>
						<div id="range" class="controls bui-form-group"	>	
							<input id="tlxt" name="tlxt" class="input-normal control-text" type="text" value="${transport.tlxt}">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tlxdh" name="tlxdh" type="text"
								class="input-normal control-text" value="${transport.tlxdh}">
						</div>
					</div>
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tchdh" name="tchdh" type="text"
								class="input-normal control-text" value="${transport.tchdh}">
						</div>
					</div>
					...
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tzxf" name="tzxf" type="text"
								class="input-normal control-text"  data-rules="{number:true}" value="${transport.tzxf}">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tshf" name="tshf" type="text"
								class="input-normal control-text"  data-rules="{number:true}" value="${transport.tshf}">
						</div>
					</div>
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tthf" name="tthf" type="text"
								class="input-normal control-text"  data-rules="{number:true}" value="${transport.tthf}">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tthch"  name="tthch" type="text"
								class="input-normal control-text" value="${transport.tthch}">
						</div>
					</div>
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tthr" name="tthr" type="text"
								class="input-normal control-text" value="${transport.tthr}">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							<input  id="tsjdh" name="tsjdh" type="text"
								class="input-normal control-text" value="${transport.tsjdh}">
						</div>
					</div>
					<div class="control-group span8">
						...
						<div class="controls">
							<input id="tthcb" name="tthcb" type="text"
								class="input-normal control-text"  data-rules="{number:true}" value="${transport.tthcb}">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							<input  id="tgsdh" name="tgsdh" type="text"
								class="input-normal control-text" value="${transport.tgsdh}">
						</div>
					</div>
