...
<body>
<c:if test="${!empty dailybill}"  >
	<form id="J_Form" class="form-horizontal span24" name="form"
		method="post" action="dailybill_update?did=${dailybill.did}" namespace="/">
						...
						<div class="control-group span8">
							...
							<div id="range" class="controls bui-form-group"
								...
								<input id="ddate" name="ddate" class="calendar"
									data-rules="{required:true}" type="text" value="${dailybill.ddate}">
							</div>
						</div>
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="dszqk" name="dszqk" type="text"
									class="input-normal control-text"  value="${dailybill.dszqk}"/>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="dfkzw" name="dfkzw" type="text"
									class="input-normal control-text" value="${dailybill.dfkzw}">
							</div>
						</div>
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="dorder" name="dorder" type="text"
									class="input-normal control-text" value="${dailybill.dorder}">
							</div>
						</div>
						...
						<div class="control-group span15">
							...
							<div class="controls control-row4">
								<input name="dreason" class="input-large" id="dreason"
									data-tip="{text:'请填写事由信息！'}" type="text" value="${dailybill.dreason}">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="damount" name="damount" type="text"
									class="input-normal control-text" value="${dailybill.damount}">
							</div>
						</div>
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="dcard" name="dcard" type="text"
									class="input-normal control-text" value="${dailybill.dcard}">
							</div>
						</div>
					</div>
						...
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="dpayment" name="dpayment" type="text"
									class="input-normal control-text" value="${dailybill.dpayment}">
							</div>
						</div>
						<div class="control-group span8">
							...
							<div class="controls">
								<input id="dbroker" name="dbroker" type="text"
									class="input-normal control-text" value="${dailybill.dbroker}">
							</div>
						</div>
					</div>					
					<div class="row">
						<div class="control-group span15">
							...
							<div class="controls control-row4">
								<input name="dremarks" class="input-large" id="dremarks"
									data-tip="{text:'请填写备注信息！'}" type="text" value="${dailybill.dremarks}">
							</div>
						</div>
					</div>
